 ...
 */
$(function () {
    var arr = ["北京市", "重庆市", "福建省", "江苏省", "广东省", "辽宁省", "内蒙古", "山西省", "青海省", "四川省", "贵州省", "云南省", "陕西省", "西藏", "宁夏", "新疆", "广西", "海南省", "湖南省", "湖北省", "河南省", "山东省", "江西省", "安徽省", "浙江省", "上海市", "黑龙江省", "吉林省", "甘肃省", "天津市", "河北省"];
    ...
    $('.citySelect').on('click', function () {
        ...
        $('.dropProvLi').on('mouseover', function () {
            ...
            for (let j = 0; j < city[$(this).index()].length; j++) {
                $('.dropCityUl').append("<li class='dropCityLi'>" + city[$(this).index()][j][1] + "</li>");
