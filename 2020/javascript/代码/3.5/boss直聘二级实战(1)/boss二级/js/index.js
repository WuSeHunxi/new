...
var selectObj = {
    ...
    showCity: function () {
        ...
        for (var j = 0; j < li_len; j++) {
            ...
            //给每一个li添加移入事件和点击事件
            this.li_province[j].addEventListener('mouseenter', this.provinceEnter.bind(this));
            this.li_province[j].addEventListener('click', this.provinceClick.bind(this));
        }
    },
    provinceEnter: function (e) {//移入事件
    ...
    cityClick: function (e) {
        ...
        this.selectName.innerHTML = str;
        this.dragDown.style.display = 'none';
        //当出现下拉框的时候需要改变小三角的样式
        this.icon.style.backgroundPosition = '0 ' + '-2044px';
        this.bool = true;//判断三角是向上还是向下

    },

    showProvinc:function(){
        var self = this;
        this.selectName.onclick = function(){
            if(self.bool){
                self.dragDown.style.display =  'block'; 
                self.icon.style.backgroundPosition = '0 ' + '-2067px';
                self.bool =  false;
            }else{
                self.icon.style.backgroundPosition = '0 ' + '-2044px';
    ...
    provinceClick:function(){
        var str = this.li_city[0].innerHTML;
        this.selectName.innerHTML = str;
        this.dragDown.style.display = 'none';
    ...
    documentClick:function(){
        this.dragDown.onmouseleave=function(){
            var self=this;
            setTimeout(function(){
